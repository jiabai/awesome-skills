...
| 技能 | 用途 | 前置依赖 | 输入 | 输出 |
|------|------|----------|------|------|
| [video-to-text](video-to-text/SKILL.md) | 视频/音频转文字稿 | 无 | 视频/音频文件 | 带时间戳、说话人标签的文字稿 + JSON |
| [insight-extractor](insight-extractor/SKILL.md) | 长文本观点提炼 | 无 | 文字稿、会议记录、长文 | 结构化观点摘要（论点、金句、争议点、行动项） |
| [video-clipper](video-clipper/SKILL.md) | 长视频智能切片 | `video-to-text` | 视频 + 转写 JSON | 去静音、去口吃的短视频切片 |
