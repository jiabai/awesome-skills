...
```
# OpenClaw 示例
<openclaw-project>/skills/xhs-automator/

# Claude Code 示例
<your-project>/.claude/skills/xhs-automator/
```
...
git clone https://github.com/autoclaw-cc/xhs-automator.git
```
...
[![Star History Chart](https://api.star-history.com/image?repos=autoclaw-cc/xhs-automator&type=date&legend=top-left)](https://www.star-history.com/?repos=autoclaw-cc%2Fxhs-automator&type=date&legend=top-left)
