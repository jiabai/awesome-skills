...
**技能集合**：覆盖项目启动、架构可视化、交互序列图、文章插图、公众号写作、搜索、小红书运营、投资分析等领域的即用型 AI 助手技能。
...
> 适用场景：文章需要可视化流程/架构/概念、复杂概念需要转化为易懂图表时使用。英文版见 [article-diagram-en](skills/article-diagram-en/SKILL.md)。
...
### xhs-automator — 小红书自动化运营工具

AI 驱动的小红书自动化技能集合。覆盖从认证登录到内容发布、搜索发现、社交互动和复合运营的完整闭环。

**核心能力**：

- **认证登录**：Cookie / 设备指纹 / 验证码处理，多账号切换
- **内容发布**：图文笔记、视频笔记发布与编辑，支持定时发布
- **搜索发现**：关键词搜索、笔记/用户/话题检索
- **社交互动**：点赞、收藏、评论、关注、私信
- **复合运营**：批量发布、数据采集、竞品监控、自动化工作流编排

> 适用场景：需要在小红书平台进行内容发布、数据采集、竞品分析或自动化运营时使用
...
1. 选择需要的技能（如 `skills/vibe-coding-launcher/`、`skills/canvas-architect/`）
...
对于根目录的 SOUL 技能，复制整个 `SOUL/` 目录；对于 `skills/` 下的技能，复制 `skills/<skill-name>/` 目录。
...
│   │   ├── SKILL.md
│   │   └── evals/
│   ├── claude-code-skill-creator/ # Claude Code 技能创建工具
│   │   └── SKILL.md
│   ├── cycle-investment-analysis/ # 周期投资分析框架
│   │   └── SKILL.md
│   ├── vibe-coding-launcher/     # Vibe Coding 项目启动器
...
- [Skill Creator](skills/claude-code-skill-creator/SKILL.md) - 技能创建工具
- [Vibe Coding Launcher](skills/vibe-coding-launcher/SKILL.md) - Vibe Coding 项目启动器
- [Canvas Architect](skills/canvas-architect/SKILL.md) - 项目架构可视化引擎
- [Canvas Sequence](skills/canvas-sequence/SKILL.md) - 交互序列图生成引擎
- [Article Diagram](skills/article-diagram/SKILL.md) - 文章插图生成器（中文）
- [Article Diagram EN](skills/article-diagram-en/SKILL.md) - 文章插图生成器（英文）
- [WeChat Article Writer](skills/wechat-article-writer/SKILL.md) - 公众号文章写作助手
- [Baidu Search](skills/baidu-search/SKILL.md) - 百度 AI 搜索
- [Cycle Investment Analysis](skills/cycle-investment-analysis/SKILL.md) - 周期投资分析框架
- [XHS Automator](skills/xhs-automator/SKILL.md) - 小红书自动化运营工具
